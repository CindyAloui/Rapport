...
Nous souhaitons donc pour associé un score de comptabilité et de massivité à un nom mais aussi à un contexte. Nous souhaitons aussi que notre système soit généralisable à d'autre classe sémantique telle que concret/abstrait ou animé/inanimé car cela permettrait de désambiguïsé plus de mots, pour cela il faudrait que notre système n'ai besoin que d'un minimum de données supervisé pour que l'ont puisse l'entraîner pour d'autre classes facilement.
